...
$filtered_products = getCategoryProducts($conn, 'transmission-oil', $search_query, $brand_filter, $sort_type, [
    'type' => $type_filter,
...
$brands = getFilterOptions($conn, 'transmission-oil', 'brand');
$types = getFilterOptions($conn, 'transmission-oil', 'type');
$viscosities = getFilterOptions($conn, 'transmission-oil', 'viscosity');
$applications = getFilterOptions($conn, 'transmission-oil', 'application');
$volumes = getFilterOptions($conn, 'transmission-oil', 'volume');
?>
    ...
    <div class="container my-5 pt-4">
        <div class="row mb-4 align-items-center" style="padding-top: 75px;">
            <div class="col-md-8">
                ...
                <?php 
                if (!empty($search_query) || !empty($brand_filter) || !empty($type_filter) || !empty($viscosity_filter) || !empty($application_filter))
                {
                    $filters_applied = [];
                    ...
                    {
                        $filters_applied[] = 'вязкость: ' . htmlspecialchars($viscosity_filter);
                    }
                ...
                ?>
                    <p class="text-muted mt-2">
                        ...
                        ?>
                        <a href="transmission-oils.php?sort=default&page=1" class="btn btn-sm btn-outline-secondary ms-2">Показать все</a>
                    </p>
                <?php 
                } 
                ?>
        ...
        <div class="filter-section mb-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="transmission-oils.php?sort=default&page=1" class="btn btn-sm btn-outline-secondary me-2">Сбросить</a>
        ...
        <div class="products-section mb-5">
            ...
            ?>
                <div class="row g-4">
                    ...
                    {
                        $product_url = 'product_detail.php?id=' . $product['id'] . '&back=' . urlencode("transmission-oils.php?" . buildCategoryQueryString(['page' => $current_page]));
                        ?>
                                    ...
                                    <div class="product-actions d-grid gap-2">
                                        ...
                                        ?>
                                            <form method="POST" action="../../cart.php" class="add-to-cart-form">
                                                ...
                                                <input type="hidden" name="product_type" value="transmission-oil">
