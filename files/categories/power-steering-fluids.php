...
$power_steering_fluids = [
    ['id' => 1, 'title' => 'Liqui Moly Lenkungs-Getriebeoil', 'art' => 'PSF001', 'volume' => '1 л', 'price' => 1450, 'stock' => true, 'hit' => true, 'brand' => 'Liqui Moly', 'type' => 'ATF', 'color' => 'Красный'],
    ['id' => 2, 'title' => 'Febi Bilstein Hydraulikol', 'art' => 'FEBI-PS01', 'volume' => '1 л', 'price' => 980, 'stock' => true, 'hit' => false, 'brand' => 'Febi', 'type' => 'PSF', 'color' => 'Зеленый'],
    ['id' => 3, 'title' => 'Ravenol Hydraulik Fluid', 'art' => 'RAV-PS001', 'volume' => '1 л', 'price' => 1120, 'stock' => true, 'hit' => true, 'brand' => 'Ravenol', 'type' => 'ATF', 'color' => 'Красный'],
    ['id' => 4, 'title' => 'SWAG Power Steering Fluid', 'art' => 'SWAG-PS01', 'volume' => '1 л', 'price' => 890, 'stock' => false, 'hit' => false, 'brand' => 'SWAG', 'type' => 'PSF', 'color' => 'Зеленый'],
    ['id' => 5, 'title' => 'Mannol Power Steering Fluid', 'art' => 'MANN-PS01', 'volume' => '1 л', 'price' => 760, 'stock' => true, 'hit' => false, 'brand' => 'Mannol', 'type' => 'ATF', 'color' => 'Красный'],
    ['id' => 6, 'title' => 'Motul Multi ATF', 'art' => 'MOT-PS001', 'volume' => '1 л', 'price' => 1280, 'stock' => true, 'hit' => true, 'brand' => 'Motul', 'type' => 'ATF', 'color' => 'Красный'],
    ['id' => 7, 'title' => 'Castrol Transmax ATF', 'art' => 'CAST-PS01', 'volume' => '1 л', 'price' => 1350, 'stock' => true, 'hit' => false, 'brand' => 'Castrol', 'type' => 'ATF', 'color' => 'Красный'],
    ['id' => 8, 'title' => 'Mobil ATF 320', 'art' => 'MOB-PS001', 'volume' => '1 л', 'price' => 1100, 'stock' => true, 'hit' => false, 'brand' => 'Mobil', 'type' => 'ATF', 'color' => 'Красный'],
    ['id' => 9, 'title' => 'Pentosin CHF 11S', 'art' => 'PENT-PS01', 'volume' => '1 л', 'price' => 1650, 'stock' => true, 'hit' => true, 'brand' => 'Pentosin', 'type' => 'CHF', 'color' => 'Зеленый'],
    ['id' => 10, 'title' => 'Comma PSF-MV', 'art' => 'COMM-PS01', 'volume' => '1 л', 'price' => 820, 'stock' => true, 'hit' => false, 'brand' => 'Comma', 'type' => 'PSF', 'color' => 'Красный'],
    ['id' => 11, 'title' => 'Liqui Moly ATF Synth', 'art' => 'PSF002', 'volume' => '1 л', 'price' => 1550, 'stock' => true, 'hit' => false, 'brand' => 'Liqui Moly', 'type' => 'ATF', 'color' => 'Красный'],
    ['id' => 12, 'title' => 'Febi Hydraulic Oil', 'art' => 'FEBI-PS02', 'volume' => '1 л', 'price' => 1050, 'stock' => true, 'hit' => false, 'brand' => 'Febi', 'type' => 'PSF', 'color' => 'Зеленый'],
    ['id' => 13, 'title' => 'Ravenol ATF Fluid', 'art' => 'RAV-PS002', 'volume' => '1 л', 'price' => 1250, 'stock' => true, 'hit' => true, 'brand' => 'Ravenol', 'type' => 'ATF', 'color' => 'Красный'],
    ['id' => 14, 'title' => 'Motul Dexron III', 'art' => 'MOT-PS002', 'volume' => '1 л', 'price' => 1380, 'stock' => true, 'hit' => false, 'brand' => 'Motul', 'type' => 'ATF', 'color' => 'Красный'],
    ['id' => 15, 'title' => 'Pentosin CHF 202', 'art' => 'PENT-PS02', 'volume' => '1 л', 'price' => 1750, 'stock' => true, 'hit' => true, 'brand' => 'Pentosin', 'type' => 'CHF', 'color' => 'Зеленый']
];
...
$filtered_products = $power_steering_fluids;
...
<head>
    ...
    <title>Жидкости ГУР - Лал-Авто</title>
...
<div class="flex-grow-1">
    ...
    <div class="container my-5 pt-4">
        <div class="row mb-4 align-items-center" style="padding-top: 75px;">
            <div class="col-md-8">
                <h1 class="display-6 fw-bold text-primary mb-3">Жидкости ГУР</h1>
                <p class="lead text-muted mb-4">Специальные жидкости для гидроусилителя руля</p>
            </div>
        </div>
        <div class="filter-section mb-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="power-steering-fluids.php?sort=default&page=1" class="btn btn-sm btn-outline-secondary me-2">Сбросить</a>
                    ...
                    <div class="col-md-3">
                        <div class="filter-group mb-3">
                            ...
                            <select class="form-select" name="brand">
                                ...
                                <option value="Mannol" <?php echo $brand_filter === 'Mannol' ? 'selected' : ''; ?>>Mannol</option>
                                ...
                                <option value="Pentosin" <?php echo $brand_filter === 'Pentosin' ? 'selected' : ''; ?>>Pentosin</option>
                                <option value="Comma" <?php echo $brand_filter === 'Comma' ? 'selected' : ''; ?>>Comma</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="filter-group mb-3">
                            ...
                            <select class="form-select" name="type">
                                ...
                                <option value="ATF" <?php echo $type_filter === 'ATF' ? 'selected' : ''; ?>>ATF</option>
                                <option value="PSF" <?php echo $type_filter === 'PSF' ? 'selected' : ''; ?>>PSF</option>
                                <option value="CHF" <?php echo $type_filter === 'CHF' ? 'selected' : ''; ?>>CHF</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                            ...
                            <div class="product-card card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="product-specs mb-2">
                                        <small class="text-muted">Тип: '.$product['type'].' • Цвет: '.$product['color'].'</small>
                                    </div>
