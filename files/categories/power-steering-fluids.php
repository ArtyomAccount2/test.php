...
$filtered_products = getCategoryProducts($conn, 'power-steering', $search_query, $brand_filter, $sort_type, [
    'type' => $type_filter,
    'color' => $color_filter,
...
$brands = getFilterOptions($conn, 'power-steering', 'brand');
$types = getFilterOptions($conn, 'power-steering', 'type');
$colors = getFilterOptions($conn, 'power-steering', 'color');
$volumes = getFilterOptions($conn, 'power-steering', 'volume');
?>
            ...
            <div class="col-md-8">
                ...
                ?>
                    <p class="text-muted mt-2">
                        ...
                        ?>
                        <a href="power-steering-fluids.php?sort=default&page=1" class="btn btn-sm btn-outline-secondary ms-2">Показать все</a>
                    </p>
                <?php 
                } 
                ?>
        ...
        <div class="products-section mb-5">
            ...
            ?>
                <div class="row g-4">
                    ...
                    {
                        $product_url = 'product_detail.php?id=' . $product['id'] . '&back=' . urlencode("power-steering-fluids.php?" . buildCategoryQueryString(['page' => $current_page]));
                        ?>
                                    ...
                                    <div class="product-actions d-grid gap-2">
                                        ...
                                        ?>
                                            <form method="POST" action="../../cart.php" class="add-to-cart-form">
                                                ...
                                                <input type="hidden" name="product_type" value="power-steering-fluid">
